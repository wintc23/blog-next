...
const mod = {exports:{}}
new Function('require','module','exports',output)(name => name === './api/client' ? {} : name === './config' ? {BASE_URL:'/api'} : name === './stat-event' ? {trackEvent: () => {}} : name === './utils' ? {getTokenClient: () => 'site-session'} : require(name),mod,mod.exports)
